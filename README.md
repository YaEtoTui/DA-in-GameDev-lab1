...
Впервые писал отчёт на github, проработал с Google Collab. Также познакомился с Unity, изучил его механики и  успел проработать на нем. Поработал с алгоритмом линейной регрессии. Учился аннализировать графики. 
